...
/**
 * Created by YYL on 2021/11/17 : 22:19.
 */
public class HowManyLeaves {
    public static void main(String[] args) {
        ...
        System.out.println(howManyLeaves(t8));
    }

    /**
     * 求二叉树中叶子节点的个数
     */
    private static int howManyLeaves(TreeNode treeNode) {
        if (treeNode != null) {
            ...
            if (left == null && right == null) {
                ...
                return howManyLeaves(left) + howManyLeaves(right);
            }
        }
        return 0;
    }
